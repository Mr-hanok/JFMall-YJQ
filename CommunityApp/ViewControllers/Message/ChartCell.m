...
-(void)setCellFrame:(ChartCellFrame *)cellFrame
{
    ...
    [self setBackGroundImageViewImage:self.chartView from:Img_Message_FromBg to:Img_Message_ToBg];
...
{
    [self setBackGroundImageViewImage:self.currentChartView from:@"Img_Message_FromBg" to:Img_Message_ToBg];
}
