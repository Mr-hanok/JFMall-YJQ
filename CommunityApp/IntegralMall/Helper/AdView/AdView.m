...
//    [_centerImageView sd_setImageWithURL:[NSURL URLWithString:imageLinkURL[centerImageIndex]] placeholderImage:self.placeHoldImage];
    if (_imageLinkURL.count > 1) {
        ...
        [_leftImageView sd_setImageWithURL:[NSURL URLWithString:imageLinkURL[0]] placeholderImage:self.placeHoldImage];
        [_centerImageView sd_setImageWithURL:[NSURL URLWithString:imageLinkURL[0]] placeholderImage:self.placeHoldImage];
        [_rightImageView sd_setImageWithURL:[NSURL URLWithString:_imageLinkURL[0]] placeholderImage:self.placeHoldImage];
        
    }else if (_imageLinkURL.count == 0){
        [_leftImageView sd_setImageWithURL:[NSURL URLWithString:@""] placeholderImage:self.placeHoldImage];
        [_centerImageView sd_setImageWithURL:[NSURL URLWithString:@""] placeholderImage:self.placeHoldImage];
        [_rightImageView sd_setImageWithURL:[NSURL URLWithString:@""] placeholderImage:self.placeHoldImage];
    }
...
- (void)setAdTitleArray:(NSArray *)adTitleArray withShowStyle:(AdTitleShowStyle)adTitleStyle
{
    ...
    _centerAdLabel.textColor = HEXCOLOR(0xEA7E36);
...
- (void)setPageControlShowStyle:(UIPageControlShowStyle)PageControlShowStyle
{
    ...
    _pageControl.currentPageIndicatorTintColor = HEXCOLOR(0xE89C3E);
    _pageControl.pageIndicatorTintColor = LINE_COLOR;
...
{    
    ...
    if (_imageLinkURL.count > 1) {
        ...
        [_leftImageView sd_setImageWithURL:[NSURL URLWithString:_imageLinkURL[0]] placeholderImage:self.placeHoldImage];
        
        [_centerImageView sd_setImageWithURL:[NSURL URLWithString:_imageLinkURL[0]] placeholderImage:self.placeHoldImage];
