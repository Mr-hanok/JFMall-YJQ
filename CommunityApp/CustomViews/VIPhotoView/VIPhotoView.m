...
+ (void)showImage:(UIImage *)image inView:(UIView *)view {
    VIPhotoView *photoView = [[VIPhotoView alloc] initWithFrame:view.bounds andImage:image];
...
- (void)setupGestureRecognizer
{
    ...
    // lipeng add
    UITapGestureRecognizer *singletapGesture = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(removeSelfViewAnimate)];
    singletapGesture.numberOfTapsRequired = 1;
    [singletapGesture requireGestureRecognizerToFail:tapGestureRecognizer];
    [self addGestureRecognizer:singletapGesture];
}

// lipeng add
- (void)removeSelfViewAnimate {
